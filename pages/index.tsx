                ...
                <Tabs>
                    <Tab title="Projects">
                        <Card
                            ...
                            image="/images/architrice.png" monospace={true}
                        >
                            <p>
                        ...
                        <Card title="chsheet" link="https://chsheet.com/" image="/images/chsheet.png" monospace={true}>
                            <p>
                        ...
                        <Card title="owen-bot" image="/images/owenbot.png" monospace={true}>
                            <p>
                        ...
                        <Card title="Spells" image="/images/spells.png" monospace={true}>
                            <p>
                    ...
                    <Tab title="Education">
                        <Card title="Melbourne University" image="/images/unimelb.svg" contain={true}>
                        ...
                        <Card title="Melbourne High School" image="/images/mhs.png" contain={true}>
                            <p><i>2016 - 2019</i></p>
                            <p>
                    ...
                    <Tab title="About">
                        ...
                        <Card title="MHS Robotics" image="/images/mhsrc.png" contain={true}>
                            <p>
                        ...
                        <Card title="NCSS Challenge" image="/images/ncss.svg" contain={true}>
                            <p>
